...
Read in the dataset containing information on various cultural festivals: [https://drbob-richardson.github.io/Stat250_W2025/data/festivals.csv](https://drbob-richardson.github.io/Stat250_W2025/data/festivals.csv)
...
A second dataset, [https://drbob-richardson.github.io/Stat250_W2025/data/festival_attendance.csv](https://drbob-richardson.github.io/Stat250_W2025/data/festival_attendance.csv), contains attendance data with the columns Festival_Name, Year, and Attendance. Read in the festival_attendance.csv dataset. Join the attendance data with the festivals dataset using the keys Festival_Name and Year.
