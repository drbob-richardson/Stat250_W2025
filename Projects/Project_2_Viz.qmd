...
1. **Netflix Movies and TV Shows (2020-04-21)**  
   [Dataset Link](https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-04-21)  
   - *Numeric Variables*: `release_year`, `duration`  
   - *Factor Variables*: `type` (Movie/TV Show), `rating`

2. **Coffee Ratings (2020-09-08)**  
   [Dataset Link](https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-09-08)  
...
4. **Bike Share Data (2018-06-19)**  
   [Dataset Link](https://github.com/rfordatascience/tidytuesday/tree/master/data/2018/2018-06-19)  
...
5. **Plastic Pollution (2020-10-20)**  
   [Dataset Link](https://github.com/rfordatascience/tidytuesday/tree/master/data/2020/2020-10-20)  
